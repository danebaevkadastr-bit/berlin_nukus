...
class StrangeSentencesRules {
  ...
  static int pointsForDifficulty(StrangeDifficulty difficulty) {
    switch (difficulty) {
      case StrangeDifficulty.easy:
        return 10;
      case StrangeDifficulty.medium:
        return 15;
      case StrangeDifficulty.hard:
        return 20;
    }
  }
...
• Darajalar: Oson (10⭐), O'rta (15⭐), Qiyin (20⭐).
