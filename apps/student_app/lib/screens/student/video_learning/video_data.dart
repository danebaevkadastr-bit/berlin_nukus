...
final List<GermanVideo> germanVideosList = [
  ...
  const GermanVideo(
    id: 'nicos_weg_a1_f3',
    title: 'Nicos Weg A2 - Der ganze Film',
    level: 'A2',
    category: 'Nicos Weg',
    youtubeId: 'i92y72wYmbc',
    durationText: '1:48:47',
    description: 'Nicos Weg A2 darajasi uchun to\'liq film.',
    subtitles: [
      SubtitleSegment(
        startTimeSec: .0,
        endTimeSec: .0,
  ...
  const GermanVideo(
    id: 'nicos_weg_a2_f1',
    title: 'Nicos Weg B1 - Der ganze Film',
    level: 'B1',
    category: 'Nicos Weg',
    youtubeId: 'O-x51HEDRjE',
    durationText: '1:40:53',
    description: 'Nicos Weg B1 darajasi uchun to\'liq film.',
    subtitles: [
      SubtitleSegment(
        startTimeSec: .0,
        endTimeSec: .0,
  ...
  const GermanVideo(
    ...
    title: 'Easy German - Was machst du beruflich?',
    level: 'B1',
    category: 'Easy German',
    youtubeId: 'vjWwJ7v-4vE',
    durationText: '7:51',
  ...
  const GermanVideo(
    ...
    title: 'Easy German - Wie lernst du am besten Deutsch?',
    level: 'B1',
    category: 'Easy German',
    youtubeId: '4mOqTf8kGCA',
    durationText: '5:12',
