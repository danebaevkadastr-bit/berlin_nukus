    ...
    try {
      ...
      if (userProvider.firebaseUser != null) {
        ...
        if (userProvider.role != 'admin') {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(l.noAccessToApp, style: const TextStyle(fontWeight: FontWeight.bold)),
      ...
      if (e is FirebaseAuthException) {
        if (e.code == 'user-not-found') {
          errorMsg = l.authErrorUserNotFound;
        } else if (e.code == 'wrong-password' || e.code == 'invalid-credential') {
          errorMsg = l.authErrorWrongPassword;
        } else if (e.code == 'invalid-email') {
          errorMsg = l.authErrorInvalidEmail;
        } else if (e.code == 'user-disabled') {
          errorMsg = l.authErrorUserDisabled;
        } else if (e.code == 'too-many-requests') {
          errorMsg = l.authErrorTooManyRequests;
        } else {
          errorMsg = l.genericError;
        }
      }
