...
class TeacherIndividualChatScreen extends StatefulWidget {
  final String groupId;
  final String groupName;

  const TeacherIndividualChatScreen({
    super.key,
  ...
  @override
  State<TeacherIndividualChatScreen> createState() => _TeacherIndividualChatScreenState();
}

class _TeacherIndividualChatScreenState extends State<TeacherIndividualChatScreen> {
