...
class _VideoCatalogScreenState extends State<VideoCatalogScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final categories = ['Barchasi', 'Nicos Weg', 'Easy German'];
    final levels = ['Barchasi', 'A1', 'A2', 'B1'];

    final filteredVideos = germanVideosList.where((v) {
                  ...
                  child: Row(
                    children: levels.map((lvl) {
                      ...
                      return Padding(
                        ...
                        child: ChoiceChip(
                          label: Text(
                            lvl == 'Barchasi' ? 'Barcha darajalar' : 'Daraja $lvl',
                            style: TextStyle(
                              color: isSelected ? Colors.white : (isDark ? Colors.white70 : AppColors.duoTextDark),
                              fontWeight: FontWeight.w900,
                              fontSize: 12.5,
                          ...
                          checkmarkColor: Colors.white,
                          onSelected: (sel) {
                            if (sel) setState(() => _selectedLevel = lvl);
                          },
                        ),
                      );
                    }).toList(),
